...
pre-registration evidence trail are public at
\url{https://github.com/<ORG>/norm-boundary}; this is the repository
referred to throughout the paper. The evidence directory includes a frozen
snapshot of the MLflow tracking database, so the pre-registration ordering
documented below can be verified independently of our claims.
